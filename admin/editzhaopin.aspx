<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editzhaopin.aspx.cs" Inherits="admin_editzhaopin" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2" class="table_bg_size" align="center">添加人才招聘岗位</td>
            </tr>
            <tr>
                <td colspan="2">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="listbg">
                        <tr>
                            <td height="25" align="center" style="width: 202px">序号：</td>
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">招聘岗位名称：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">人数：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">年龄：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">专业：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">学历：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">性别：</td>
                            <td class="padding-left-10">&nbsp;<asp:DropDownList ID="sex" runat="server">
                        ...
                        <tr>
                            <td height="25" align="center" style="width: 202px">起止日期：</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="25" align="center">发布:</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="80" align="center" style="width: 202px">岗位要求详细信息:</td>
                            <td class="padding-left-10">
                        ...
                        <tr>
                            <td height="80" align="center" style="width: 202px">待遇:</td>
                            <td class="padding-left-10">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="width: 660px">
                                            <ce:editor id="daiyu" runat="server" width="659px" height="359px">
                                                <FrameStyle BackColor="White" BorderColor="#DDDDDD" BorderStyle="Solid" BorderWidth="1px"
                                                    CssClass="CuteEditorFrame" Height="100%" Width="100%" />
                                            </ce:editor>
                                        </td>
                        ...
                        <tr>
                            <td height="25" colspan="2" align="center">
                                <asp:Button CssClass="btn" ID="Button1" runat="server" Text="修改招聘" OnClick="Button1_Click" ValidationGroup="editpro" />
                                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<asp:Button ID="Button2" runat="server" CssClass="btn"
                                    OnClick="Button2_Click" Text="返回上页" />
                            </td>
                        </tr>
                    </table>
                </td>
