                ...
                <td colspan="2" valign="top">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="listbg">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            ...
                            <td width="30%">
                                <strong><a href ='<%#"see_gb.aspx?urls="+Server.UrlEncode(sqlhelper.cupage())+"&id="+Eval("id") %>'><%# Eval("title") %></a></strong></td>
                            <td width="25%">
                                <strong><%# Eval("compamyname")%></strong></td>  
                            <td width="20%">
                                <strong><%# Eval("times")%></strong></td> 
                        </tr>   
                            </ItemTemplate>
                        </asp:Repeater>
                        <tr>
