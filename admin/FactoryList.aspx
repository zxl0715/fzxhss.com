<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FactoryList.aspx.cs" Inherits="admin_FactoryList" %>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href='<%#"FactoryEdit.aspx?urls="+Server.UrlEncode(sqlhelper.cupage())+"&id="+Eval("pro_id") %>'>编辑</a>&nbsp;|&nbsp;<a href='<%#"?action=del&urls="+Server.UrlEncode(sqlhelper.cupage())+"&id="+Eval("pro_id") %>'
