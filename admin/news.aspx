                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                            <td height="25" align="center" bgcolor="#FFFFFF">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="新闻点击数只能为数字"
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="listbg">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    <td height="22" align="center">
                                        <input id="xinwenxuhao" type="text" runat="server" value='<%# Eval("order") %>' style="width: 25px;
                                            color: #990000; border: 1px solid #CCC; text-align: center;" />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="新闻序号必需填写"
                                            ControlToValidate="xinwenxuhao" Display="None"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="新闻序号只能为数字"
                                            ValidationExpression="^[0-9]*$" ControlToValidate="xinwenxuhao" Display="None"></asp:RegularExpressionValidator>
                                        <input id="linshixinwenid" type="text" runat="server" value='<%# Eval("new_id") %>' style="display: none;" />
                                    </td>
                                    <td align="center">
                                        <input name='xinwenid' type='checkbox' id="xinwenid" value='<%# Eval("new_id") %>'></td>
                                    ...
                                    <td width="11%" align="center">
                                        <img alt="" width="120" height="120" src='<%# "file/"+getfirst(DataBinder.Eval(Container.DataItem, "pro_img").ToString())%>' />
                                    </td>
                                    <td align="center">
                                        <%# Eval("time", "{0:d}")%>
                                    </td>
                                    <td align="center">
                                        <a href='<%#"editnew.aspx?urls="+Server.UrlEncode(sqlhelper.cupage())+"&id="+Eval("new_id") %>'>
                                            编辑</a>&nbsp;|&nbsp;<a href='<%#"?action=del&urls="+Server.UrlEncode(sqlhelper.cupage())+"&id="+Eval("new_id") %>'
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="50%" align="left" style="height: 22px">
                                            <asp:Button CssClass="btn"  ID="Button2" runat="server" Text="删除选中新闻" OnClientClick="return confirm('确定要删除吗')"
