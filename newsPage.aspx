<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="newsPage.aspx.cs" Inherits="newsPage" Title="福州兴辉盛世文化传播有限公司" %>
    ...
    <div class="sidebar width">
        ...
        <div class=" sb-DG">
            <h3 class="sb--box-title">
                <div class="sb--box-size fl">当前位置：<a href="index.html" title="首页">首页</a> &gt; <a href="newsPage.html">新闻中心</a></div>
